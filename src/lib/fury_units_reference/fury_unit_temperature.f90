!< FURY definition of unit *reference* temperature.
module fury_unit_temperature
!-----------------------------------------------------------------------------------------------------------------------------------
!< FURY definition of unit *reference* temperature.
!-----------------------------------------------------------------------------------------------------------------------------------
...
!-----------------------------------------------------------------------------------------------------------------------------------
type, extends(unit_abstract) :: unit_temperature
  !< Definition of temperature unit.
  character(13) :: dimensionality_='[temperature]' !< Predefined dimensionality.
  contains
    ! public deferred methods
    procedure, nopass :: is_compatible !< Check if unit is compatible with another one.
endtype unit_temperature

interface unit_temperature
  !< Ovearloading unit_temperature name with a creator function.
...
contains
  ...
  type(unit_temperature)             :: unit           !< The unit.
  !---------------------------------------------------------------------------------------------------------------------------------
...
endmodule fury_unit_temperature

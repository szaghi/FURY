!< FURY definition of unit *reference* luminosity.
module fury_unit_luminosity
!-----------------------------------------------------------------------------------------------------------------------------------
!< FURY definition of unit *reference* luminosity.
!-----------------------------------------------------------------------------------------------------------------------------------
...
!-----------------------------------------------------------------------------------------------------------------------------------
type, extends(unit_abstract) :: unit_luminosity
  !< Definition of luminosity unit.
  character(13) :: dimensionality_='[luminousity]' !< Predefined dimensionality.
  contains
    ! public deferred methods
    procedure, nopass :: is_compatible !< Check if unit is compatible with another one.
endtype unit_luminosity

interface unit_luminosity
  !< Ovearloading unit_luminosity name with a creator function.
...
contains
  ...
  type(unit_luminosity)              :: unit           !< The unit.
  !---------------------------------------------------------------------------------------------------------------------------------
...
endmodule fury_unit_luminosity

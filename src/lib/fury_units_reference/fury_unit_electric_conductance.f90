!< FURY definition of unit *reference* electric_conductance.
module fury_unit_electric_conductance
!-----------------------------------------------------------------------------------------------------------------------------------
!< FURY definition of unit *reference* electric_conductance.
!-----------------------------------------------------------------------------------------------------------------------------------
...
!-----------------------------------------------------------------------------------------------------------------------------------
type, extends(unit_abstract) :: unit_electric_conductance
  !< Definition of electric_conductance unit.
  character(22) :: dimensionality_='[electric_conductance]' !< Predefined dimensionality.
  contains
    ! public deferred methods
    procedure, nopass :: is_compatible !< Check if unit is compatible with another one.
endtype unit_electric_conductance

interface unit_electric_conductance
...
contains
  ...
  type(unit_electric_conductance)    :: unit         !< The unit.
  !---------------------------------------------------------------------------------------------------------------------------------
  ...
  !---------------------------------------------------------------------------------------------------------------------------------
  select type(unit)
  class is(unit_electric_conductance)
    compatible = .true.
  class default
    compatible = .false.
  endselect
...
endmodule fury_unit_electric_conductance

!< FURY definition of siemens unit.
module fury_unit_siemens
!-----------------------------------------------------------------------------------------------------------------------------------
!< FURY definition of siemens unit.
!-----------------------------------------------------------------------------------------------------------------------------------
use fury_unit_electrical_conductance
use penf
!-----------------------------------------------------------------------------------------------------------------------------------
...
!-----------------------------------------------------------------------------------------------------------------------------------
type, extends(unit_electrical_conductance) :: unit_siemens
  !< Definition of siemens unit.
  contains
    ! public overrided methods
    procedure, pass(self) :: set !< set the unit.
endtype unit_siemens

interface unit_siemens
  !< Ovearloading unit_siemens name with a creator function.
...
contains
  ...
  type(unit_siemens)                 :: unit           !< The unit.
  !---------------------------------------------------------------------------------------------------------------------------------
  ...
  !< @todo Load from file.
  !---------------------------------------------------------------------------------------------------------------------------------
  class(unit_siemens), intent(inout)         :: self           !< The unit.

...
print "(A,L1)", '2._R8P * 1.0 kg.m.s-2 = '//force3%stringify(format='(F3.1)')//', is correct? ', test_passed(2)

force3 = force1 * 2._R4P
test_passed(3) = force3%stringify(format='(F3.1)')=='2.0 kg.m.s-2'
print "(A,L1)", '2._R4P * 1.0 kg.m.s-2 = '//force3%stringify(format='(F3.1)')//', is correct? ', test_passed(3)

force3 = force1 * 2_I8P
test_passed(4) = force3%stringify(format='(F3.1)')=='2.0 kg.m.s-2'
print "(A,L1)", '2_I8P * 1.0 kg.m.s-2 = '//force3%stringify(format='(F3.1)')//', is correct? ', test_passed(4)

force3 = force1 * 2_I4P
test_passed(5) = force3%stringify(format='(F3.1)')=='2.0 kg.m.s-2'
print "(A,L1)", '2_I4P * 1.0 kg.m.s-2 = '//force3%stringify(format='(F3.1)')//', is correct? ', test_passed(5)

force3 = force1 * 2_I2P
test_passed(6) = force3%stringify(format='(F3.1)')=='2.0 kg.m.s-2'
print "(A,L1)", '2_I2P * 1.0 kg.m.s-2 = '//force3%stringify(format='(F3.1)')//', is correct? ', test_passed(6)

force3 = force1 * 2_I1P
test_passed(7) = force3%stringify(format='(F3.1)')=='2.0 kg.m.s-2'
print "(A,L1)", '2_I1P * 1.0 kg.m.s-2 = '//force3%stringify(format='(F3.1)')//', is correct? ', test_passed(7)

force3 = 2._R8P *  force1
test_passed(8) = force3%stringify(format='(F3.1)')=='2.0 kg.m.s-2'
print "(A,L1)", '1.0 kg.m.s-2 * 2._R8P = '//force3%stringify(format='(F3.1)')//', is correct? ', test_passed(8)

force3 = 2._R4P *  force1
test_passed(9) = force3%stringify(format='(F3.1)')=='2.0 kg.m.s-2'
print "(A,L1)", '1.0 kg.m.s-2 * 2._R4P = '//force3%stringify(format='(F3.1)')//', is correct? ', test_passed(9)

force3 = 2_I8P * force1
test_passed(10) = force3%stringify(format='(F3.1)')=='2.0 kg.m.s-2'
print "(A,L1)", '1.0 kg.m.s-2 * 2_I8P = '//force3%stringify(format='(F3.1)')//', is correct? ', test_passed(10)

force3 = 2_I4P * force1
test_passed(11) = force3%stringify(format='(F3.1)')=='2.0 kg.m.s-2'
print "(A,L1)", '1.0 kg.m.s-2 * 2_I4P = '//force3%stringify(format='(F3.1)')//', is correct? ', test_passed(11)

force3 = 2_I2P * force1
test_passed(12) = force3%stringify(format='(F3.1)')=='2.0 kg.m.s-2'
print "(A,L1)", '1.0 kg.m.s-2 * 2_I2P = '//force3%stringify(format='(F3.1)')//', is correct? ', test_passed(12)

force3 = 2_I1P * force1
test_passed(13) = force3%stringify(format='(F3.1)')=='2.0 kg.m.s-2'
print "(A,L1)", '1.0 kg.m.s-2 * 2_I1P = '//force3%stringify(format='(F3.1)')//', is correct? ', test_passed(13)

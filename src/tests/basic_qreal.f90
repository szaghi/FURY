...
aquantity = qreal(magnitude=1.2_R_P, unit=si%metre)
test_passed(1) = aquantity%magnitude<1.21_R_P

call aquantity%set(magnitude=2.2_R_P, unit=si%metre)
test_passed(2) = aquantity%magnitude<2.21_R_P

aquantity = qreal(magnitude=1._R_P, unit=si%metre)
anotherquantity = qreal(magnitude=1._R_P, unit=si%metre)

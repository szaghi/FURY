!< FURY test of [[qreal]].
program fury_test_qreal_eq_mixed
!-----------------------------------------------------------------------------------------------------------------------------------
!< FURY test of [[qreal]].
!-----------------------------------------------------------------------------------------------------------------------------------
use fury
...
print "(A,L1)", '1 * force(float32) == 1 * force(float64) => '//trim(str(test_passed(1)))//', is correct? ', test_passed(1)

test_passed(2) = force2 == force1
print "(A,L1)", '1 * force(float64) == 1 * force(float32) => '//trim(str(test_passed(2)))//', is correct? ', test_passed(2)

test_passed(3) = force1 == force3
print "(A,L1)", '1 * force(float32) == 1 * force(float128) => '//trim(str(test_passed(3)))//', is correct? ', test_passed(3)

test_passed(4) = force3 == force1
print "(A,L1)", '1 * force(float128) == 1 * force(float32) => '//trim(str(test_passed(4)))//', is correct? ', test_passed(4)

test_passed(5) = force2 == force3
print "(A,L1)", '1 * force(float64) == 1 * force(float128) => '//trim(str(test_passed(5)))//', is correct? ', test_passed(5)
